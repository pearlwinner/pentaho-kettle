  ...
  public void editNamedConfiguration() {
    try {
      ...
      if ( namedConfigurations != null && !namedConfigurations.isEmpty() ) {
        ...
        NamedConfiguration original = ( (UINamedConfiguration) namedConfigurations.toArray()[0] ).getNamedConfiguration().clone();
        ...
        if ( idNamedConfiguration == null ) {
          ...
          if ( namedConfigurationName != null && !namedConfigurationName.equals( "" ) ) {
            ...
            if ( !original.getName().equals( namedConfiguration.getName() ) ) {
              // delete original
              repository.deleteNamedConfiguration( original.getName() );
            }
